    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clickableSpan = object : ClickableSpan() {
            ...
            override fun updateDrawState(ds: TextPaint) {
                ...
                ds.color = ContextCompat.getColor(this@LoginActivity, R.color.green_500) // Mengatur warna teks yang diklik
            }
...
// Menambahkan ClickableSpan pada bagian teks yang ingin diklik
        ...
        spannableString.setSpan(boldSpan, text.indexOf("Daftar"), text.indexOf("Daftar") + "Daftar".length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
